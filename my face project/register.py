...
class Register:
    def __init__(self,root):
        ...
        img3=Image.open(r"C:\my face project\images\sss.jpg")
        img3=img3.resize((1530,780),Image.ANTIALIAS)
        self.photoimg3=ImageTk.PhotoImage(img3)

        bg_image=Label(self.root,image=self.photoimg3)
        bg_image.place(x=0,y=0,width=1530,height=780)
        ...
        if (self.var_fname.get()=="" or self.var_lname.get()=="" or self.var_cnum.get()=="" or self.var_email.get()=="" or self.var_ssq.get()=="Select" or self.var_sa.get()=="" or self.var_pwd.get()=="" or self.var_cpwd.get()==""):
            ...
            try:
                ...
                if row!=None:
                    ...
                    my_cursor.execute("insert into registration values(%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
                    self.var_id.get(),
                    self.var_fname.get(),
                    self.var_lname.get(),
                    self.var_cnum.get(),
